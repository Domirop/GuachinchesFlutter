...
import 'package:guachinches/data/cubit/filter/filter_map_state.dart';
...
class FilterBarMap extends StatefulWidget {
  ...
  FilterBarMap({required this.showCategoryChip,
    required this.categories,
    required this.municipalities,
    required this.types,
    required this.filterMap,
    this.withSearchBar = false, this.zoomOut});

  @override
  State<FilterBarMap> createState() => _FilterBarMapState();
}

class _FilterBarMapState extends State<FilterBarMap> {
  ...
  late FilterCubitMap filterCubitMap;
  String text = '';
  ...
  void initState() {
    ...
    filterCubitMap = context.read<FilterCubitMap>();
          ...
          child: GestureDetector(
            onTap: () =>
                GlobalMethods().pushPage(
                    context, SearchText(zoomOut: widget.zoomOut)),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  BlocBuilder<FilterCubitMap, FilterMapStateCubit>(
                      builder: (context, state) {
                        if (state is FilterCategoryMap) {
                              ...
                              return GestureDetector(
                                onTap: () =>
                                {
                                  setState(() {
                                    ...
                                    filterCubitMap.handleFilterChange(
                                        selectedCategories,
                                        selectedMunicipalities,
                                        typesSelected, '');
